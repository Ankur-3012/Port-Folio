...
export const Banner = () => {
  ...
  const toRotate = ["Web Developer", "Web Designer", "UI/UX Designer", "ML Enthusiast"];
  const period = 500;
            ...
            <TrackVisibility>
              {({ isVisible }) =>
                <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                  ...
                  <h1>
                    {`Hey! It's me Ankur`} 
                    <span className="txt-rotate" data-period="1000" data-rotate='[ "Web Developer", "Web Designer", "UI/UX Designer" , "ML Enthusiast"]'>
